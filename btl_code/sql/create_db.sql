...
-- cần tắt ONLY_FULL_GROUP_BY để cho phép truy vấn các thuộc tính của view ngoài các thuộc tính có trong phần groupby :_)
...
group by t.id, s.year, r.raceNumber;
...
group by stat.seasonYear, stat.teamId;
...
(5, 1, 5455026, -1, 0, 2, 6, 3),
(6, 1, 5455026, -1, 0, 2, 5, 3),
(16, 1, 5455026, -1, 0, 2, 16, 10),
(13, 1, -1, -1, 0, 2, 11, 7),
